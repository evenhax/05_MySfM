...
//        }
        ...
        if (poseInliersRatio < POSE_INLIERS_MINIMAL_RATIO_INITIAL) {

            cout << "Insufficient pose inliers for initial. skip to next." << endl;
...
//        }
        ...
        mReconstructionCloud = myPointCloud;
